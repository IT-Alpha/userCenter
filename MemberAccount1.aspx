...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <section class="pt-4 pt-xl-0 pb-3" id="myAccount" @keydown.enter="preventEnter">
                <div class="d-none">
                        ...
                        <div class="col-12">
                            <div class="panel admin-panel">
                                ...
                                <div class="panel-body">
                                    <div class="row mx-0">
                                        <div class="flex-column col-12 col-md-6 px-0">
                                            <!-- 註冊日期欄位 X -->
                                            <div class="d-none">
                                                        ...
                                                        <div class="modal fade px-0" id="mobileModal" tabindex="-1" role="dialog">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="mx-auto" style="max-width: 180px">
                                                                            <asp:TextBox ID="PhoneTBX" runat="server" class="d-none"></asp:TextBox>
                                                                            <input type="text" v-model="phone" class="form-control p-3 mb-2" placeholder="請輸入新的手機號碼" MaxLength="10" @keyup.enter="savePhone">
                                                                        </div>
                                                                        <h4 class="text-secondary">{{ alert.phone }}</h4>
                                                                    </div>
                                                                    <div class="modal-footer border-top-0 justify-content-center pt-0">
                                                                        <button type="button" class="btn btn-primary" :disabled="phoneNotPass" @click="savePhone">確認</button>
                                                                        <button type="button" class="btn btn-outline-primary" data-dismiss="modal" @click="cancel">
                                                                            取消
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="modal fade px-0" id="emailModal" tabindex="-1" role="dialog">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="mx-auto" style="max-width: 180px">
                                                                            <asp:TextBox ID="EmailTBX" runat="server" MaxLength="50" placeholder="請輸入新的Email" class="d-none"></asp:TextBox>
                                                                            <input type="text" placeholder="請輸入新的Email"  MaxLength="50" class="form-control p-3 mb-2" v-model="email"
                                                                            inputmode="email" @keyup.enter="saveEmail">
                                                                        </div>
                                                                        <h4 class="text-secondary">{{ alert.email }}</h4>
                                                                    </div>
                                                                    <div class="modal-footer border-top-0 justify-content-center pt-0">
                                                                        <button type="button" class="btn btn-primary" @click="saveEmail" :disabled="emailNotPass">確認</button>
                                                                        <button type="button" class="btn btn-outline-primary" data-dismiss="modal" @click="cancel">
                                                                            取消
                                                                        </button>
                                                                    </div>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="mx-auto" style="width: 80%">
                                                                            <asp:TextBox ID="AddressTBX1" runat="server" class="d-none"></asp:TextBox>
                                                                            <input type="text" MaxLength="100" placeholder="請輸入戶籍地址" class="form-control p-3 mb-2" v-model="reAddress" @keyup.enter="saveReAddress">
                                                                        </div>
                                                                        <h4 class="text-secondary">{{ alert.reAddress }}</h4>
                                                                    </div>
                                                                    <div class="modal-footer border-top-0 justify-content-center pt-0">
                                                                        <button type="button" class="btn btn-primary" :disabled="reAddressNotPass" @click="saveReAddress">確認</button>
                                                                        <button type="button" class="btn btn-outline-primary" data-dismiss="modal" @click="cancel">
                                                                            取消
                                                                        </button>
                                                                    </div>
                                                    ...
                                                    <div class="text-center mb-3 mb-sm-0">
                                                        ...
                                                        <div class="modal fade px-0" id="maAddressModal" tabindex="-1" role="dialog">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header bg-primary">
                                                                        <h4 class="modal-title flex-grow-1 text-center text-light">修改通訊地址</h4>
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                            <span aria-hidden="true">&times;</span>
                                                                        </button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <div class="mx-auto" style="width: 80%">
                                                                            <asp:TextBox ID="AddressTBX2" runat="server" class="d-none"></asp:TextBox>
                                                                            <input type="text" class="form-control p-3 mb-2" v-model="maAddress" MaxLength="100" placeholder="請輸入通訊地址" @keyup.enter="saveMaAddress">
                                                                        </div>
                                                                        <h4 class="text-secondary">{{ alert.maAddress }}</h4>
                                                                    </div>
                                                                    <div class="modal-footer border-top-0 justify-content-center pt-0">
                                                                        <button type="button" class="btn btn-primary" @click="saveMaAddress" :disabled="maAddressNotPass">確認</button>
                                                                        <button type="button" class="btn btn-outline-primary" data-dismiss="modal" @click="cancel">
                                                                            取消
                                                                        </button>
                                                                    </div>
                            ...
                            <div class="panel admin-panel">
                                ...
                                <div class="panel-body">
                                                                        ...
                                                                        <div class="mx-auto" style="width:100%">
                                                                            ...
                                                                            <div class="paycard-set mb-3">
                                                                                ...
                                                                                <div class="mx-auto d-flex justify-content-start flex-wrap" style="width: 70%">
                                                                                    ...
                                                                                    <div class="custom-control custom-radio custom-radio-info d-inline-block col-12 col-sm-4 px-1">
                                                                                        <input type="radio" id="cardTypeVISA" class="custom-control-input" name="cardType" value="1" v-model="cardType">
                                                                                        <label class="custom-control-label" for="cardTypeVISA">
                                                                                            VISA
                                                                                        </label>
                                                                                    </div>
                                                                                    <div class="custom-control custom-radio custom-radio-info d-inline-block col-12 col-sm-4 px-1">
                                                                                        <input type="radio" id="cardTypeMC" class="custom-control-input" name="cardType" value="2" v-model="cardType">
                                                                                        <label class="custom-control-label" for="cardTypeMC">
                                                                                            MasterCard
                                                                                        </label>
                                                                                    </div>
                                                                                    <div class="custom-control custom-radio custom-radio-info d-inline-block col-12 col-sm-4 px-1">
                                                                                        <input type="radio" id="cardTypeJCB" class="custom-control-input" name="cardType" value="3" v-model="cardType">
                                                                            ...
                                                                            <div class="paycard-set mb-3">
                                                                                ...
                                                                                <div class="d-flex flex-wrap">
                                                                                    <!-- 信用卡號 -->
                                                                                    <div class="">
                                                                                        <asp:TextBox ID="CardNumTBX1" runat="server" MaxLength="4" style="width:80px;"></asp:TextBox>
                                                                                        <asp:TextBox ID="CardNumTBX2" runat="server" MaxLength="4" style="width:80px;"></asp:TextBox>
                                                                                        <asp:TextBox ID="CardNumTBX3" runat="server" MaxLength="4" style="width:80px;"></asp:TextBox>
                                                                                        <asp:TextBox ID="CardNumTBX4" runat="server" MaxLength="4" style="width:80px;"></asp:TextBox>
                                                                                    </div>
                                                                                    <div class="d-flex">
                                                                                        <input type="text" MaxLength="4" class="form-control mb-2 px-0 text-center" inputmode="numeric" v-for="(item, i) in 4" v-model="cardNum[i]" @keyup="index = i, cardNumChange()" ref="cardNum">
                                                                                    </div>
                                                                            ...
                                                                            <div class="paycard-set mb-3 w-100">
                                                                                ...
                                                                                <!-- 有效月/年 -->
                                                                                <div class="d-flex flex-wrap col-6 px-0 mx-auto">
                                                                                    <asp:TextBox ID="MonthTBX" runat="server" MinLength="2" MaxLength="2" style="width:80px;"></asp:TextBox>
                                                                                    <asp:TextBox ID="YearTBX" runat="server" MinLength="2" MaxLength="2" style="width:80px;"></asp:TextBox>
                                                                                    <div class="d-flex">
                                                                                        <input type="text" MaxLength="2" class="form-control p-3 mb-2 mr-2 paycard text-center px-0" v-for="(item, i) in 2" inputmode="numeric" v-model="cardEx[i]" @keyup="exIndex = i, cardExChange()" ref="cardEx">
                                                                                    </div>
                                                                                </div>
                                                                                <hr style="opacity:.3">
                                                                            </div>
                                                                            <div class="d-flex flex-wrap w-100 paycard-set">
                                                                                <div class="col-4 px-0 pr-2">
                                                                                    ...
                                                                                    <!-- 安全碼 -->
                                                                                    <asp:TextBox ID="CardCodeTBX" runat="server" MaxLength="3"></asp:TextBox>
                                                                                    <input type="text" MaxLength="3" class="form-control p-3 mr-2 text-center paycard" inputmode="numeric" v-model="cardCCV" @keyup="cardCCVchange" @focus="cardCheckChange" ref="cardCCV">
                                                                                </div>
                                                                                <div class="col-8 px-0">
                                                                                    <h5 class="pb-2 text-primary">發卡銀行</h5>
                                                                                     <!-- 發卡銀行 -->
                                                                                    <asp:TextBox ID="BankNameTBX" runat="server" MaxLength="20"></asp:TextBox>
                                                                                    <input type="text" MaxLength="20" class="form-control p-3 text-center paycard" v-model="cardBank" @keyup="cardBankChange" ref="cardBank">
                                                                                </div>
                                                                                <hr style="opacity:.3">
                                                                            </div>
                                                                            <h4 class="text-secondary">{{ alert.card.number }}</h4>
                                                                            <h4 class="text-secondary">{{ alert.card.expire }}</h4>
                                                                            <h4 class="text-secondary">{{ alert.card.ccv }}</h4>
                                                                            <h4 class="text-secondary">{{ alert.card.bank }}</h4>
                                                                            <h4 class="text-secondary">{{ alert.card.type }}</h4>

                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer border-top-0 justify-content-center">
                                                                        <button type="button" class="btn btn-primary" :disabled="cardNotPass" @click="saveCard">確認</button>
                                                                        <button type="button" class="btn btn-outline-primary" data-dismiss="modal">
                                                                            取消
                                                                        </button>
                                                                    </div>
                                    ...
                                    <div class="row mx-0 justify-content-end">
                                        <div>
                                            <span class="px-3">您的下一個收費日期為 2020 / 11 / 5 </span>
                                            <button type="button" class="btn btn-primary">付款紀錄</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
