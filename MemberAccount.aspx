<%@ Page Title="" Language="vb" AutoEventWireup="false"
  MasterPageFile="~/MainStatic.Master" CodeBehind="MemberAccount.aspx.vb"
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
  ...
  <asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
                    ...
                    <div class="row">
                      ...
                      <div class="col-12 col-md-6 px-0">
                        <div class="d-flex flex-column flex-sm-row
                          ...
                          <div class="py-3 pl-4 flex-grow-1">
                            <asp:Label ID="NameLB" runat="server"></asp:Label>
                          </div>
                          <div class="text-center mb-3 mb-sm-0">
                            <button class="btn btn-outline-primary py-1" data-toggle="modal"
                      ...
                      <div class="col-12 col-md-6 px-0">
                        <div class="d-flex flex-column flex-sm-row
                          ...
                          <div class="py-3 pl-4">supprot@roboadvisor.com.tw</div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 px-0">
                        <div class="d-flex flex-column flex-sm-row
                          ...
                          <div class="py-3 pl-4 flex-grow-1">******</div>
                          <div class="text-center mb-3 mb-sm-0">
                            <button class="btn btn-outline-primary py-1" data-toggle="modal"
                              data-target="#passwordModal">修改</button>
                            <div class="modal fade px-0" id="passwordModal" tabindex="-1" role="dialog">
                                  ...
                                  <div class="modal-body">
                                    <div class="mx-auto" style="max-width:180px">
                                      <asp:TextBox ID="PwdTBX" runat="server" MaxLength="20"
                                        class="form-control p-3 mb-2" TextMode="Password" placeholder="請輸入舊密碼"
                                        Style="border-radius: 2rem;" />
                      ...
                      <div class="col-12 col-md-6 px-0">
                        <div class="d-flex flex-column flex-sm-row border-bottom">
                          ...
                          <div class="text-center mb-3 mb-sm-0">
                            <button class="btn btn-outline-primary py-1" data-toggle="modal"
                              data-target="#birthdayModal">修改</button>
                            <div class="modal fade px-0" id="birthdayModal" tabindex="-1" role="dialog">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  <div class="modal-header bg-primary">
                                    <h4 class="modal-title flex-grow-1
                                  ...
                                  <div class="modal-body">
                                    <div class="mx-auto" style="max-width:180px">
                                      <asp:DropDownList ID="YearDDL" runat="server" AutoPostBack="True" Font-Names="DFLiHeiLight,Medium"
          Font-Size="16pt" Width="100px" Height="40" Style="border-radius: 2rem;" class="form-control p-3 mb-2">
        </asp:DropDownList>年
        <asp:DropDownList ID="MonthDDL" runat="server" AutoPostBack="True" Font-Names="DFLiHeiLight,Medium"
      ...
      <asp:DropDownList ID="DayDDL" runat="server" Font-Names="DFLiHeiLight,Medium" Font-Size="16pt" Width="100px"
          Height="40">
          <asp:ListItem Value="0">請選擇</asp:ListItem>
        </asp:DropDownList>日 
                                    </div>
                      ...
                      <!-- <div class="col-12 col-md-6 px-0">
                        <div class="d-flex border-bottom">
                          <div class="py-3 text-center bg-200" style="min-width: 8rem;">理財顧問</div>
                          <div class="py-3 pl-4">423423</div>
                        </div>
                      </div> -->
                      <div class="col-12 px-0">
                        <div class="d-flex flex-column
                                        flex-sm-row">
                          <div class="pt-4 py-sm-3 text-center" style="min-width: 8rem;">會員條款</div>
                          <div class="py-3 pl-4">
      ...
      <div>
        ...
        <!-- 年<asp:DropDownList ID="MonthDDL" runat="server" AutoPostBack="True" Font-Names="DFLiHeiLight,Medium"
          Font-Size="16pt" Width="100px" Height="40">
          <asp:ListItem Value="0">請選擇</asp:ListItem>
          <asp:ListItem>01</asp:ListItem>
          <asp:ListItem>02</asp:ListItem>
        ...
        月<asp:DropDownList ID="DayDDL" runat="server" Font-Names="DFLiHeiLight,Medium" Font-Size="16pt" Width="100px"
          Height="40">
          <asp:ListItem Value="0">請選擇</asp:ListItem>
        </asp:DropDownList>日 -->
        <!-- <asp:Button ID="BirthdayBTN" runat="server" class="btn btn-primary" Text="確定" /> -->
