...
let components = {
  ...
  breadcrumbs: {
    ...
    styles: './components/breadcrumbs/breadcrumbs.min.css'
  },
  badge: {
    selector: '.badge',
    ...
    init: function (nodes) {
      ...
      let lineSetting = {
        ...
        series: [
          {
            name: '退休金準備',
            data: [150000, 160000, 180000, 190000, 210000, 225000, 270000, 300000, 340000, 370000, 400000, 450000, 180000, 190000, 210000, 225000, 270000, 300000, 340000, 370000, 400000, 450000],
            shadow: {
              enabled: true,
              color: "#00000",
              width: 5,
